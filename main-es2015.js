...
/* harmony import */ var _stack_stack_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./stack/stack.component */ "./src/app/stack/stack.component.ts");
/* harmony import */ var _contact_validation_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./contact/validation.service */ "./src/app/contact/validation.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _stack_stack_component__WEBPACK_IMPORTED_MODULE_10__["StackComponent"]
        ],
        imports: [
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_14__["ReactiveFormsModule"],
            _angular_common_http__WEBPACK_IMPORTED_MODULE_15__["HttpClientModule"],
            _app_routes__WEBPACK_IMPORTED_MODULE_13__["globalRoutes"]
        ],
        providers: [
            _contact_validation_service__WEBPACK_IMPORTED_MODULE_11__["ValidationService"],
            _contact_contact_service__WEBPACK_IMPORTED_MODULE_12__["ContactService"]
        ],
...
const globalRoutes = _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forRoot(appRoutes);
...
/* harmony import */ var _validation_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./validation.service */ "./src/app/contact/validation.service.ts");
/* harmony import */ var _contact_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./contact.service */ "./src/app/contact/contact.service.ts");
...
let ContactComponent = class ContactComponent {
    constructor(router, formBuilder, validationService, contactService) {
        this.router = router;
    ...
    createForm() {
        ...
        this.contactForm = this.formBuilder.group({
            ...
            'message': ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
                ])],
        });
    }
    onSubmit(message) {
        if (this.contactForm.valid) {
            ...
            this.contactService.sendEmail(message).subscribe((data) => { this.handleResponse(data); }, (err) => { this.handleError(err); });
        }
        else {
...
ContactComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _validation_service__WEBPACK_IMPORTED_MODULE_3__["ValidationService"], _contact_service__WEBPACK_IMPORTED_MODULE_4__["ContactService"]])
], ContactComponent);
...
StackComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./stack.component.css */ "./src/app/stack/stack.component.css")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
], StackComponent);
...
module.exports = __webpack_require__(/*! M:\Keil\Other\Development\Webstorm Projects\PersonalSite\src\main.ts */"./src/main.ts");
